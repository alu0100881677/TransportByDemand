 ...
 */
public class GeneradorFrentePareto {
  public void generarFichero(String ar1, String ar2) throws IOException {

    String inputFileName = ar1 ;
    String outputFileName = ar2 ;
